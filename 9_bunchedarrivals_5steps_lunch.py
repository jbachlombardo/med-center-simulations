...
sims_thruput_follow_up = np.empty(shape = n_sims)
...
for sim in range(n_sims) :
    ...
    total_service_time_final = mean_service_time_check_in_final + mean_service_time_refine_complaint_final + mean_service_time_exam_final + mean_service_time_follow_up_final + mean_service_time_checkout_final
    total_waiting_time_final = mean_waiting_time_check_in_final + mean_waiting_time_refine_complaint_final + mean_waiting_time_exam_final + mean_waiting_time_follow_up_final + mean_waiting_time_checkout_final
    ...
    sims_thruput_follow_up[sim] = served_follow_up_final / arrived_follow_up_final
...
print ('Total thruput of follow_up: {:.2f}'.format(np.mean(sims_thruput_follow_up)))
print ('    [0.2, 0.8]:', np.percentile(sims_thruput_follow_up, [20, 80]))
